...
describe('PendingNewComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ PendingNewComponent,GrdFilterPipe ],
      providers: [{provide: LeaveDetailsService, 
        useValue: pendingServiceStub},
        HttpClient,
  ...
  it('should Check Leave Id for Emp Id 9999', () => {
    const fixture = TestBed.createComponent(PendingNewComponent);
